                ...
                <div className='row'>
                    <div className='col-7'>
                        <div className='checkout-left-data'>
                            <h3 className='website-name'>Bike Shop</h3>
                            <nav 
                            ...
                            <p className='user-details total'>Lautaro Bacega (lautibacega@gmail.com)</p>
                            ...
                            <form action='' className='d-flex gap-15 flex-wrap justify-content-between'>
                                ...
                                <div className='w-100'>
                                    <input type='text' placeholder='Apartment, Suite, ect' className='form-control'></input>
                                </div>
                                <div className='flex-grow-1'>
                        ...
                        <div className='border-bottom py-4'>
                            <div className='d-flex gap-10 mb-2 align-items-center'>
                                <div className='w-75 d-flex gap-10'>
                                    ...
                                    <div>
                                        <h5 className='total-price'>SmartWatch</h5>
                                        <p className='total-price'>'codigo de producto'</p>
                                    </div>
                                </div>
                                <div className='flex-grow-1'>
